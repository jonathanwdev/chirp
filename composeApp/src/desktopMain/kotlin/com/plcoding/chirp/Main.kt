...
fun main(args: Array<String>) {
    ...
    val initialDeepLink = args.firstOrNull {
        ...
        DesktopDeepLinkHandler.supportedUriPatterns.any { pattern ->
    ...
    application {
        ...
        var canReceiveDeepList by remember { mutableStateOf(false) }
        val appTheme = rememberAppTheme(applicationState.themePreferences)

        LaunchedEffect(canReceiveDeepList) {
            if(canReceiveDeepList && initialDeepLink != null) {
