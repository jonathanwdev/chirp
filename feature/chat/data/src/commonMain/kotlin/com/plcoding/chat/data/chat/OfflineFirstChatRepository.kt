...
class OfflineFirstChatRepository(
    ...
    override fun getChats(): Flow<List<Chat>> {
        return db.chatDao
            ...
            .map { allChatWithParticipantList ->
                supervisorScope {
                    allChatWithParticipantList
                        .map { chatWithParticipants ->
                            async {
                                ChatWithParticipants(
                                    chat = chatWithParticipants.chat,
                                    participants = chatWithParticipants.participants.onlyActive(chatWithParticipants.chat.chatId),
        ...
        return db.chatDao.getChatInfoById(chatId)
            ...
            .map { chatInfo ->
                ChatInfoEntity(
                    ...
                    messageWithSenders = chatInfo.messageWithSenders
                )
            }
            .map {
                it.toDomain()
