...
fun ChatItemHeaderRow(
    ...
    Row(
        ...
        Column(
            ...
            if (isGroupChat) {
                val youInChat = stringResource(Res.string.you)
                val formattedUserNames = remember(chat.otherParticipantUi) {
                    "$youInChat, " + chat.otherParticipantUi.joinToString(", ") { it.username }
                }
                Text(
