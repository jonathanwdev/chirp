...
import com.plcoding.chat.presentation.screens.chat_list_detail.ChatListDetailAdaptiveLayout
...
fun NavGraphBuilder.chatGraph(
    ...
    navigation<ChatGraphRoutes.Graph>(
        ...
        composable<ChatGraphRoutes.ChatListDetailRoute>(
            ...
            val chatId = backStackEntry.toRoute<ChatGraphRoutes.ChatListDetailRoute>()

            ChatListDetailAdaptiveLayout(
                initialChatId = chatId.chatId,
                onLogout = {}
            )
        }
    }
