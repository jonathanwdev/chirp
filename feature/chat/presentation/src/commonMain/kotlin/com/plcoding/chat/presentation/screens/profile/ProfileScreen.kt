...
fun ProfileRoot(
    ...
    val pickerLauncher = rememberImagePickerLauncher { result ->
        ...
        ProfileSectionLayout(
            ...
            ChirpPasswordTextField(
                ...
                onToggleVisibilityClick = {
                    onAction(ProfileAction.OnToggleCurrentPasswordConfirmation)
                }
            )
            ChirpPasswordTextField(
                ...
                onToggleVisibilityClick = {
                    onAction(ProfileAction.OnToggleNewPasswordConfirmation)
                }
            )
